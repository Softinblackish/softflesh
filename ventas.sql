...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-07-2020 a las 06:18:21
...
--
-- Estructura de tabla para la tabla `tbl_cxp_pagar`
--
CREATE TABLE `ventas`.`tbl_cxp_pagar` (
  `ID` INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(45),
  `detalle` VARCHAR(45),
  `cantidad` INTEGER DEFAULT 1,
...
--
-- Estructura de tabla para la tabla `cod_impuestos`
--
...
--
-- Indices de la tabla `cod_impuestos`
--
...
--
-- AUTO_INCREMENT de la tabla `cod_impuestos`
--
ALTER TABLE `tbl_cod_impuestos`
