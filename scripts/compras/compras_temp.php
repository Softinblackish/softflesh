<?php
    ...
    */
    ...
    //echo $empresa . " " .$no_compra." ".$caducidad." ".$hora." ".$nombre_proveedor." ".$direccion_proveedor." ".$tel_proveedor.  " ".$email_proveedor." ".$cod_impuesto." ".$valor_impuesto." ".$sin_impuesto." ".$articulo." ".$precio_compra." ".$cantidad." ".$valor_total." ".$nota." ".$forma_pago." ".$moneda." ".$stock." ".$comprobante." ".$entregar_a." ".$condicion_pago;
        ...
        $Reg_compras = $conexion->query("insert into $empresa.tbl_compras_temp (no_compra, caducidad, nombre_proveedor,cod_proveedor, cod_impuesto, valor_impuesto, sin_impuesto, forma_pago , moneda, stock, comprobante, entregar_a, condicion_pago)
            values ($no_compra, '$caducidad', '$nombre_proveedor', '$cod_proveedor',  $cod_impuesto, $valor_impuesto $sin_impuesto ,    $forma_pago , $moneda, $stock, $comprobante, $entregar_a, $condicion_pago)
            ");

        $Reg_compras = $conexion->query("insert into $empresa.tbl_art_compras_temp (no_compra, articulo, precio_compra, cantidad, valor_total, nota)
