...
<body>
    <div id=contenedor>
        <header>
            <div id="menu_top" >
                <div id="logo" class="option_top">Logo</div>
                <div id="notificaciones" class="option_top">notificacion</div>
                <div id="usuario" class="option_top">usuario</div>
            </div>
        </header>
        <aside>
              <nav>
                <div id="menu_lateral">
                    ...
                    <div id="menu">
                        <div id="clientes" class="menu_lv1"><i class="fa fa-users" aria-hidden="true"></i> Clientes
                        ...
                        <div id="suplidores" class="menu_lv1"><i class="fa fa-handshake-o" aria-hidden="true"></i> Suplidores
                        ...
                        <div id="ventas" class="menu_lv1"><i class="fa fa-cart-plus" aria-hidden="true"></i> Ventas
                        ...
                        <div id="compras" class="menu_lv1"> <i class="fa fa-shopping-bag" aria-hidden="true"></i> Compras 
                        ...
                        <div id="cxp" class="menu_lv1"><i class="fa fa-credit-card" aria-hidden="true"></i> Cuentas por pagar
                        ...
                        <div id="cxc" class="menu_lv1"><i class="fa fa-money" aria-hidden="true"></i> Cuentas por cobrar
                        ...
                        <div id="inventario" class="menu_lv1"><i class="fa fa-bar-chart" aria-hidden="true"></i> Inventario
