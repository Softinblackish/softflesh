...
<ul class="list-group">
  ...
  <a href="../usuarios/nuevo_usuario.php"><li class="list-group-item" ><i class="fa fa-plus-circle"></i> Agregar</li></a>
  <a href="../usuarios/lista_usuarios.php"><li class="list-group-item"><i class="fa fa-eye"></i> Ver usuarios</li></a>
