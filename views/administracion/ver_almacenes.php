...
<table class="table">
  ...
  <?php 
    ...
    if(isset($_POST["filtro"])){
        $filtro= $_POST["filtro"];
        $lista_impuestos = $conexion->query("SELECT * FROM $empresa.tbl_almacenes WHERE nombre_almacen LIKE '%$filtro%'");
    }
    else{
        $lista_impuestos = $conexion->query("SELECT * FROM $empresa.tbl_almacenes");
    }
...
?>
        <!-- Head Tabla impuestos   --->
            <tr>
                ...
                <td><?php echo $row["descripcion_almacen"];?></td>
